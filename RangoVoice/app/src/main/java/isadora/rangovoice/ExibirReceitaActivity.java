...
public class ExibirReceitaActivity extends AppCompatActivity implements RecognitionListener {
    ...
    private static final String KEYPHRASE = "ok michael"; //Palavra-chave para ativar microfone.
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        googleRecognizer.setRecognitionListener(new android.speech.RecognitionListener() {
            ...
            public void onBeginningOfSpeech() {
                ...
                makeText(getApplicationContext(), "Inicio", Toast.LENGTH_SHORT).show();
            }
            ...
            public void onEndOfSpeech() {
                makeText(getApplicationContext(), "Fim", Toast.LENGTH_SHORT).show();
            }
            ...
            public void onError(int error) {
                ...
                makeText(getApplicationContext(), "Error:" + getErrorText(error), Toast.LENGTH_SHORT).show();
                aguardarKeyword();
            }
            ...
            public void onResults(Bundle results) {
                ...
                makeText(getApplicationContext(), "Results: " + textoInterpretado, Toast.LENGTH_SHORT).show();
